    ...
    public class EnemySphereAerial : MonoBehaviour
    {
        ...
        private void UpdateDrift()
        {
            ...
            if (flatDist < 20f)
            {
                ...
                _visual?.SetMode(EnemyVisualMode.Charging);
        ...
        private void UpdateCooldown()
        {
            ...
            {
                _state = AerialState.Drift;
                _visual?.SetMode(EnemyVisualMode.Patrol);
            }
        }
        ...
        {
            _target = player;
            if (_state == AerialState.Drift) _visual?.SetMode(EnemyVisualMode.Patrol);
        }

        private void OnPlayerLost()
        {
            _target = null;
            if (_state == AerialState.Drift) _visual?.SetMode(EnemyVisualMode.Idle);
        }
