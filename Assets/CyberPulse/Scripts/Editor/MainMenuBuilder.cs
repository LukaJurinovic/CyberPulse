...
namespace CyberPulse.Editor
{
    ...
    public static class MainMenuBuilder
    {
        ...
        public static void Build()
        {
            ...
            // Register as the startup scene (index 0) so it loads first in a build.
            EnsureSceneInBuildSettings(ScenePath, 0);

            Debug.Log("[CyberPulse] Main Menu built and registered as startup scene (build index 0).");
        }
        ...
        private static MainMenuController BuildSystems(GameObject cam)
        {
            ...
            // Gather the bundled tracks the player can choose from (excludes action stems).
        ...
        private static void AddEventSystem()
        {
            ...
            // New Input System is the active handler — the legacy StandaloneInputModule
            // throws InvalidOperationException reading UnityEngine.Input, so use the
            // Input System UI module instead. InputModuleBootstrap assigns its default
            // actions at runtime (build-time assignment wouldn't serialize) so buttons work.
            go.AddComponent<UnityEngine.InputSystem.UI.InputSystemUIInputModule>();
            go.AddComponent<InputModuleBootstrap>();
        }
        ...
        /// <summary>
        /// Returns all selectable tracks under Assets/Audio/Music, excluding action
        /// stems (names containing action/combat/intense) which are crossfade layers,
        /// not standalone songs.
        /// </summary>
